...
loader.innerHTML = '<div align="center" style="position:fixed;background:orange;border:2px solid white;top:35%;left:3%;right:3%;font-size:x-large;box-shadow:  -8px -2px 8px 8px white, -8px 8px 8px 8px #D9D9D9, 8px 12px 12px 12px white;"">' +
    loadmsg +
    '<hr><i>Starting...</i><br><br><i>' +
    cDate + '</i></div>';
...
function word_click() {
	...
	*/
	...
	document.write.innerHTML = localStorage.setItem('dicthistory', val); 
...
function lookupEachDict(dictarr, voca, guess_meaning, better_meaning, dictname, specialoption) {
	...
	if (meaning_from_dict != "undefined") {
		better_meaning = "<br><font color='#004400'><strong style='font-size:110%'>" + dictname + ": </strong></font>" + "<font color='#004400'>" + meaning_from_dict + "</font>";
		found_count++;
		guess_meaning = "";
	}
