...
var rdom = Math.round(((Math.random()) * (loadmsgarr.length - 1)));
var loadmsg = loadmsgarr[rdom];

loader.innerHTML = '<div align="center" style="position:fixed;background:orange;border:2px solid white;top:35%;left:0%;right:0%;font-size:x-large; box-shadow:  -8px -2px 8px 8px white, -8px 8px 8px 8px #D9D9D9, 8px 12px 12px 12px white;"">' + loadmsg + '<hr><i>loading data...</i></div>';
...
function viewMM() {
  ...
  for (var p = 0; p < textin.length; p++) {
    ...
    //$("a#export").html('<img src="images/b_ftext.png">&nbsp;&nbsp;Export&nbsp;&nbsp;&nbsp;');
    //$("a#help_icon_vn").html('<img src="images/help.png">Hướng dẫn');
  }
}
