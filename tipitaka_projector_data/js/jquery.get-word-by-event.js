...
(function ($) {
	...
	function expandRangeToWord(range) {
		...
		/**
		* Added by PNRY (17-10-2019) to highlight the selected word
		* On iOS, may need to select the text manually for the first time
		* This can use with the pseudo CSS [not all browsers support this css]
		* ::selection { color:yellow; background:red;}
		*/
		if (document.getSelection) {
			var sel_object = document.getSelection();			
			sel_object.addRange(range);
			sel_object = "";
		}
